...
import 'package:Bourreau/components/word_button.dart';
import 'package:Bourreau/utilities/alphabet.dart';
import 'package:Bourreau/utilities/hangman_words.dart';
import 'package:flutter/material.dart';
import 'package:Bourreau/screens/home_screen.dart';
import 'package:Bourreau/utilities/constants.dart';
import 'package:Bourreau/utilities/score_db.dart' as score_database;
import 'package:Bourreau/utilities/user_scores.dart';
      ...
      if (hangState == 6) {
        ...
        if (lives < 1) {
          ...
          Alert(
              ...
              context: context,
              title: "Fin du jeu!",
              desc: "Votre score est $wordCount",
              buttons: [
                DialogButton(
